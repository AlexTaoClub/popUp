var popUp = {
    ...
    alert: function(opt) {
        ...
        this.textTemplate.animate = opt.animate || this.textTemplate.animate;
        var box = document.createElement("div"),
        _this = this;
        box.className = this.containerClass;
        box.innerHTML = this.getAlertTemplate();
        document.body.appendChild(box);
        var postbirdBoxContent=document.getElementsByClassName("postbird-box-content")[0];
        postbirdBoxContent.classList.add(this.textTemplate.animate);
